...
BOUNDARY_PATTERNS: dict[str, tuple[str, ...]] = {
    ...
    "kernel_intake": (
        ...
        "src/ev4_transition/pcvp_carrier.py",
        "src/ev4_transition/pcvp_owner.py",
        "contracts/locks/kernel-decision-intake.v1.lock.json",
        "contracts/locks/pcvp-v1.lock.json",
        "contracts/vendor/decision-kernel/pcvp/**",
        ...
        "tests/producer_integration/test_pcvp_*.py",
    ),
    "producer_integration": (
